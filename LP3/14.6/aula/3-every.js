/*
    ...
    ===> Every <===
    O método every, testa se todos os elementos da array passam no teste executado 
    pela função em que fornecemos e retorna um boolean
*/
const bonde = [
  {
    apelido: "Lis",
...
/* Todas as pessoas são vegetarianas? */
console.log(bonde.every((pessoa) => pessoa.vegetariana === true));

/* Todas as pessoas tem pets? */
