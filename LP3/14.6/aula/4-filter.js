/*
    ...
    ===> Filter <===
    Devolve um  novo array com os valores filtrados
*/
const bonde = [
  {
    apelido: "Lis",
...
/* Todos as pessoas do bonde que tenham pets */
const bondePets = bonde.filter((pessoa) => !pessoa.pets.length);

/* Todas as pessoas do bonde que não sejam vegetarianas */
const bondeNaoVeggie = bonde.filter((pessoa) => pessoa.vegetariana == !true);
const bondeVeggie = bonde.filter((pessoa) => pessoa.vegetariana === true);

/* Todas as pessoas que tenham mais de 50 reais na conta */
const ryckas = bonde.filter((pessoa) => pessoa.saldoNaConta >= 30000);
console.log(ryckas);