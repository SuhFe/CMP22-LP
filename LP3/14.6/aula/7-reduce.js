/*
    ...
    ===> Reduce <===
    Retorna uma acumulação de valores
*/
const bonde = [
  {
    apelido: "Lis",
...
/* Juntando nossas riquezas, qual a soma do saldo na conta de todas nós? */
// const riquezaBonde = [2, 3, 4, 5, 6, 7];

const riquezaBondeList = bonde.map((pessoa) => pessoa.saldoNaConta);
const riquezaBondeReais = riquezaBondeList.reduce(
  (valorAnterior, valorAtual) => valorAnterior + valorAtual,
  0
);
console.log(riquezaBondeReais);